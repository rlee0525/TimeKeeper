...
gid1 = Tag.create(user: uid1, name: "People")
gid2 = Tag.create(user: uid1, name: "History")
gid3 = Tag.create(user: uid1, name: "Way")
gid4 = Tag.create(user: uid1, name: "Art")
gid5 = Tag.create(user: uid1, name: "World")
gid6 = Tag.create(user: uid1, name: "Information")
gid7 = Tag.create(user: uid1, name: "Map")
gid8 = Tag.create(user: uid1, name: "Two")
gid9 = Tag.create(user: uid1, name: "Government")
gid10 = Tag.create(user: uid1, name: "Health")
gid11 = Tag.create(user: uid1, name: "System")
gid12 = Tag.create(user: uid1, name: "Computer")
gid13 = Tag.create(user: uid1, name: "Meat")
gid14 = Tag.create(user: uid1, name: "Year")
gid15 = Tag.create(user: uid1, name: "Thanks")
gid16 = Tag.create(user: uid1, name: "Music")
gid17 = Tag.create(user: uid1, name: "Person")
gid18 = Tag.create(user: uid1, name: "Data")
gid19 = Tag.create(user: uid1, name: "Method")
gid20 = Tag.create(user: uid1, name: "Theory")
gid21 = Tag.create(user: uid1, name: "Communication")
gid22 = Tag.create(user: uid1, name: "Growth")
gid23 = Tag.create(user: uid1, name: "Marriage")
gid24 = Tag.create(user: uid1, name: "Income")
gid25 = Tag.create(user: uid1, name: "Fishing")
gid26 = Tag.create(user: uid1, name: "News")
gid27 = Tag.create(user: uid1, name: "Goal")
gid28 = Tag.create(user: uid1, name: "Department")
gid28 = Tag.create(user: uid1, name: "Article")
gid29 = Tag.create(user: uid1, name: "Freedom")
gid30 = Tag.create(user: uid1, name: "University")
gid31 = Tag.create(user: uid1, name: "Camera")
gid32 = Tag.create(user: uid1, name: "Army")
gid33 = Tag.create(user: uid1, name: "Series")
gid34 = Tag.create(user: uid1, name: "Policy")
gid35 = Tag.create(user: uid1, name: "Analysis")
gid37 = Tag.create(user: uid1, name: "Physics")
gid38 = Tag.create(user: uid1, name: "Equipment")
gid39 = Tag.create(user: uid1, name: "Organization")
gid40 = Tag.create(user: uid1, name: "Exam")
gid41 = Tag.create(user: uid1, name: "Country")
gid42 = Tag.create(user: uid1, name: "Security")
gid43 = Tag.create(user: uid1, name: "Week")
gid44 = Tag.create(user: uid1, name: "Variety")
gid45 = Tag.create(user: uid1, name: "Safety")
gid46 = Tag.create(user: uid1, name: "Quality")
gid47 = Tag.create(user: uid1, name: "Community")
gid48 = Tag.create(user: uid1, name: "Media")
gid49 = Tag.create(user: uid1, name: "Idea")
gid50 = Tag.create(user: uid1, name: "Fact")
gid51 = Tag.create(user: uid1, name: "Nature")
gid52 = Tag.create(user: uid1, name: "Economics")
gid53 = Tag.create(user: uid1, name: "Love")
gid54 = Tag.create(user: uid1, name: "Control")
gid55 = Tag.create(user: uid1, name: "Software")
gid56 = Tag.create(user: uid1, name: "Literature")
gid57 = Tag.create(user: uid1, name: "Bird")
gid58 = Tag.create(user: uid1, name: "Sign")
gid59 = Tag.create(user: uid1, name: "Search")
gid60 = Tag.create(user: uid1, name: "Talk")
gid61 = Tag.create(user: uid1, name: "Stop")
gid62 = Tag.create(user: uid1, name: "Trip")
gid63 = Tag.create(user: uid1, name: "Ski")
gid64 = Tag.create(user: uid1, name: "Sail")
gid65 = Tag.create(user: uid1, name: "Ride")
gid66 = Tag.create(user: uid1, name: "Question")
gid67 = Tag.create(user: uid1, name: "Observe")
gid68 = Tag.create(user: uid1, name: "Move")
gid69 = Tag.create(user: uid1, name: "Meet")
gid70 = Tag.create(user: uid1, name: "Manage")
gid71 = Tag.create(user: uid1, name: "Mail")
gid72 = Tag.create(user: uid1, name: "Mark")
gid73 = Tag.create(user: uid1, name: "Jump")
gid74 = Tag.create(user: uid1, name: "Jest")
gid75 = Tag.create(user: uid1, name: "Jam")
gid76 = Tag.create(user: uid1, name: "Identify")
gid77 = Tag.create(user: uid1, name: "Guard")
gid78 = Tag.create(user: uid1, name: "Garden")
gid79 = Tag.create(user: uid1, name: "Law")
gid80 = Tag.create(user: uid1, name: "Food")
gid81 = Tag.create(user: uid1, name: "Educate")
gid82 = Tag.create(user: uid1, name: "Comment")
gid83 = Tag.create(user: uid1, name: "Cook")
gid84 = Tag.create(user: uid1, name: "Crawl")
gid85 = Tag.create(user: uid1, name: "Dream")
gid86 = Tag.create(user: uid1, name: "Enjoy")
gid87 = Tag.create(user: uid1, name: "Eat")
gid88 = Tag.create(user: uid1, name: "Debate")
gid89 = Tag.create(user: uid1, name: "Dance")
gid90 = Tag.create(user: uid1, name: "Read")
gid91 = Tag.create(user: uid1, name: "Break")
gid92 = Tag.create(user: uid1, name: "TV")
gid93 = Tag.create(user: uid1, name: "Movie")
gid94 = Tag.create(user: uid1, name: "Travel")
gid95 = Tag.create(user: uid1, name: "Family")
gid96 = Tag.create(user: uid1, name: "School")
gid97 = Tag.create(user: uid1, name: "Work")
gid98 = Tag.create(user: uid1, name: "Social")
gid99 = Tag.create(user: uid1, name: "Rest")
gid100 = Tag.create(user: uid1, name: "Jump")
gid101 = Tag.create(user: uid1, name: "Exercise")
gid102 = Tag.create(user: uid1, name: "Newspaper")
gid103 = Tag.create(user: uid1, name: "Driver")
gid104 = Tag.create(user: uid1, name: "Flight")
gid105 = Tag.create(user: uid1, name: "Cell")
gid106 = Tag.create(user: uid1, name: "Lake")
gid107 = Tag.create(user: uid1, name: "Opportunity")
gid108 = Tag.create(user: uid1, name: "Introduction")
gid109 = Tag.create(user: uid1, name: "Flight")
gid110 = Tag.create(user: uid1, name: "Length")
gid111 = Tag.create(user: uid1, name: "Magazine")
gid112 = Tag.create(user: uid1, name: "Relationship")
gid113 = Tag.create(user: uid1, name: "Member")
gid114 = Tag.create(user: uid1, name: "Phone")
gid115 = Tag.create(user: uid1, name: "Message")
gid116 = Tag.create(user: uid1, name: "Scene")
gid117 = Tag.create(user: uid1, name: "Appearance")
gid118 = Tag.create(user: uid1, name: "Customer")
gid119 = Tag.create(user: uid1, name: "Discussion")
gid120 = Tag.create(user: uid1, name: "Housing")
gid121 = Tag.create(user: uid1, name: "Inflation")
gid122 = Tag.create(user: uid1, name: "Insurance")
gid123 = Tag.create(user: uid1, name: "Opinion")
gid124 = Tag.create(user: uid1, name: "Responsibility")
gid125 = Tag.create(user: uid1, name: "Situation")
gid126 = Tag.create(user: uid1, name: "Skill")
gid127 = Tag.create(user: uid1, name: "Statement")
gid128 = Tag.create(user: uid1, name: "Wealth")
gid129 = Tag.create(user: uid1, name: "Application")
gid130 = Tag.create(user: uid1, name: "City")
gid131 = Tag.create(user: uid1, name: "County")
gid132 = Tag.create(user: uid1, name: "Estate")
gid133 = Tag.create(user: uid1, name: "Foundation")
gid134 = Tag.create(user: uid1, name: "Perspective")
gid135 = Tag.create(user: uid1, name: "Photo")
gid136 = Tag.create(user: uid1, name: "Recipe")
gid137 = Tag.create(user: uid1, name: "Passion")
gid138 = Tag.create(user: uid1, name: "Imagination")
gid139 = Tag.create(user: uid1, name: "Ad")
gid140 = Tag.create(user: uid1, name: "Agency")
gid141 = Tag.create(user: uid1, name: "College")
gid142 = Tag.create(user: uid1, name: "Connection")
gid143 = Tag.create(user: uid1, name: "Debt")
gid144 = Tag.create(user: uid1, name: "Memory")
gid145 = Tag.create(user: uid1, name: "Solution")
gid146 = Tag.create(user: uid1, name: "Attitude")
gid147 = Tag.create(user: uid1, name: "Union")
gid148 = Tag.create(user: uid1, name: "Agreement")
gid149 = Tag.create(user: uid1, name: "Region")
gid150 = Tag.create(user: uid1, name: "Tradition")
gid151 = Tag.create(user: uid1, name: "Device")
gid152 = Tag.create(user: uid1, name: "Difficulty")
gid153 = Tag.create(user: uid1, name: "Election")
gid154 = Tag.create(user: uid1, name: "Bread")
gid155 = Tag.create(user: uid1, name: "Climate")
gid156 = Tag.create(user: uid1, name: "Elevator")
gid157 = Tag.create(user: uid1, name: "Construction")
gid158 = Tag.create(user: uid1, name: "Employee")
gid159 = Tag.create(user: uid1, name: "Leadership")
gid160 = Tag.create(user: uid1, name: "Operation")
gid161 = Tag.create(user: uid1, name: "Editor")
gid162 = Tag.create(user: uid1, name: "Feedback")
gid163 = Tag.create(user: uid1, name: "Resolution")
gid164 = Tag.create(user: uid1, name: "Revenue")
gid165 = Tag.create(user: uid1, name: "Session")
gid166 = Tag.create(user: uid1, name: "Tennis")
gid167 = Tag.create(user: uid1, name: "Bonus")
gid168 = Tag.create(user: uid1, name: "Church")
gid169 = Tag.create(user: uid1, name: "Clothes")
gid170 = Tag.create(user: uid1, name: "Coffee")
gid171 = Tag.create(user: uid1, name: "Dinner")
gid172 = Tag.create(user: uid1, name: "Lunch")
gid173 = Tag.create(user: uid1, name: "Breakfast")
gid174 = Tag.create(user: uid1, name: "Lab")
gid175 = Tag.create(user: uid1, name: "Orange")
gid176 = Tag.create(user: uid1, name: "Pie")
gid177 = Tag.create(user: uid1, name: "Warning")
gid178 = Tag.create(user: uid1, name: "Worker")
gid179 = Tag.create(user: uid1, name: "Writer")
gid180 = Tag.create(user: uid1, name: "Chocolate")
gid181 = Tag.create(user: uid1, name: "Cookie")
gid182 = Tag.create(user: uid1, name: "Grocery")
gid183 = Tag.create(user: uid1, name: "Honey")
gid184 = Tag.create(user: uid1, name: "Menu")
gid185 = Tag.create(user: uid1, name: "Beer")
gid186 = Tag.create(user: uid1, name: "Apple")
gid187 = Tag.create(user: uid1, name: "Negotiation")
gid188 = Tag.create(user: uid1, name: "Pizza")
gid189 = Tag.create(user: uid1, name: "Time")
gid190 = Tag.create(user: uid1, name: "Study")
gid191 = Tag.create(user: uid1, name: "Economy")
gid192 = Tag.create(user: uid1, name: "Value")
gid193 = Tag.create(user: uid1, name: "Company")
gid194 = Tag.create(user: uid1, name: "Price")
gid195 = Tag.create(user: uid1, name: "Risk")
gid196 = Tag.create(user: uid1, name: "Research")
gid197 = Tag.create(user: uid1, name: "Test")
gid198 = Tag.create(user: uid1, name: "Stock")
gid199 = Tag.create(user: uid1, name: "Design")
gid200 = Tag.create(user: uid1, name: "Profit")
